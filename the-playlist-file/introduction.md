...
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| `int`    | Integer                                                                                                                                                       | `3`, `-41`            |
| `bool`   | <p>Must be either <code>0</code> or <code>1</code><br><br>Typically used for PlaylistVars with only 2 possible values, such as<code>replay_enabled</code></p> | `0`                   |
| `float`  | Rational numbers                                                                                                                                              | `3.14`                |
| `string` | <p>Plain text<br><br><strong>Must be surrounded by</strong> <code>"</code></p>                                                                                | `"mp_weapon_mastiff"` |
